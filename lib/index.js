...
var addData = (nextProps, chart, setIndex, pointIndex) => {
  var values = []
...
var updatePoints = (nextProps, chart, dataKey) => {
  var name = chart.name
...
module.exports = {
  createClass: function(type, methodNames, data) {
    var excludedProps = ['data', 'options', 'redraw'];

    var classData = {
      displayName: type + 'Chart',
    ...
    classData.initializeChart = function(nextProps) {
      ...
      var chart = new Chart(ctx)[type](nextProps.data, nextProps.options || {})
    ...
    classData.getChart = function() {
      return this.state.chart // return instance chartjs
    }

    classData.getCanvases = function() {
      return this.refs.canvases; // return canvases element that contains the chart
    };

    classData.getCanvas = classData.getCanvases;
